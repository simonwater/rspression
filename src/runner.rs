...
use crate::environment::{Environment, DefaultEnvironment};
...
impl LoxRunner {
    ...
    pub fn execute_with_env<E: Environment>(&mut self, expression: &str, env: &mut E) -> LoxResult<Value> {
    ...
    pub fn execute_multiple_with_env<E: Environment>(&mut self, expressions: &[&str], env: &mut E) -> LoxResult<Vec<Value>> {
